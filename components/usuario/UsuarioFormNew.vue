    ...
    <form class="py-4 px-6" action="" method="POST">
      ...
      <div class="mb-4">
        ...
        >
          ...
          <option value="haircut">Aspirante</option>
          <option value="coloring">Alumno</option>
          <option value="styling">Maestro</option>
          <option value="facial">Recursos Humanos</option>
        </select>
      </div>
